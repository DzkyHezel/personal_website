<section class="container page-contents">
    ...
    <div class="mt-4">
        ...
        <div class="d-flex  flex-wrap justify-content-start gap-2">
            ...
            <button class="wow fadeInUp btn <?= is_null($active_year) ? 'btn-primary' : 'btn-outline-primary' ?> px-5"
                data-wow-delay="1s" onclick="sortByYear(null)">
                All
            </button>
            <button
                class="wow fadeInUp btn <?= ($yr[0] == $active_year) ? 'btn-primary' : 'btn-outline-primary' ?> px-4"
                data-wow-delay="1s" onclick="sortByYear(2025)"> 2025 </button>
            <button
                class="wow fadeInUp btn <?= ($yr[1] == $active_year) ? 'btn-primary' : 'btn-outline-primary' ?> px-4"
                data-wow-delay="1s" onclick="sortByYear(2024)"> 2024 </button>
            <button
                class="wow fadeInUp btn <?= ($yr[2] == $active_year) ? 'btn-primary' : 'btn-outline-primary' ?> px-4"
                data-wow-delay="1s" onclick="sortByYear(2023)"> 2023 </button>
            <button
                class="wow fadeInUp btn <?= ($yr[3] == $active_year) ? 'btn-primary' : 'btn-outline-primary' ?> px-4"
                data-wow-delay="1s" onclick="sortByYear(2022)"> 2022 </button>
            <button
                class="wow fadeInUp btn <?= ($yr[4] == $active_year) ? 'btn-primary' : 'btn-outline-primary' ?> px-4"
                data-wow-delay="1s" onclick="sortByYear(2021)"> 2021 </button>
            <button
                class="wow fadeInUp btn <?= ($yr[5] == $active_year) ? 'btn-primary' : 'btn-outline-primary' ?> px-4"
                data-wow-delay="1s" onclick="sortByYear(2020)"> 2020 </button>
        ...
        <div class="container mt-4">
            <h4 class="uni-title purple wow fadeInUp" data-wow-delay="1s">2025</h4>
            <div class="row mt-4">
                <?php 
        ...
        <!-- art filter 2024 -->
        <div class="container mt-4">
            <h4 class="uni-title purple wow fadeInUp" data-wow-delay="1s">2024</h4>
            <div class="row mt-4">
                <?php 
            $filter = array_filter($artworks, function ($art) {
        ...
        <!-- art filter 2023 -->
        <div class="container mt-4">
            <h4 class="uni-title purple wow fadeInUp" data-wow-delay="1s">2023</h4>
            <div class="row mt-4">
                <?php 
            $filter = array_filter($artworks, function ($art) {
        ...
        <!-- art filter 2022 -->
        <div class="container mt-4">
            <h4 class="uni-title purple wow fadeInUp" data-wow-delay="1s">2022</h4>
            <div class="row mt-4">
                <?php 
            $filter = array_filter($artworks, function ($art) {
        ...
        <!-- art filter 2021 -->
        <div class="container mt-4">
            <h4 class="uni-title purple wow fadeInUp" data-wow-delay="1s">2021</h4>
            <div class="row mt-4">
                <?php 
            $filter = array_filter($artworks, function ($art) {
        ...
        <!-- art filter 2020 -->
        <div class="container mt-4">
            <h4 class="uni-title purple wow fadeInUp" data-wow-delay="1s">2020</h4>
            <div class="row mt-4">
                <?php 
            $filter = array_filter($artworks, function ($art) {
        ...
        <div class="container mt-4">
            <div class="d-flex flex-row justify-content-center">
                <h4 class="uni-title purple wow fadeInUp" data-wow-delay="1s"><?= $active_year ?> </h4>&nbsp; <p
                    class="wow fadeInUp" data-wow-delay="1s">- <?= $count_art ?> arts during <?= $active_year?>.</p>
            </div>
            <div class="row mt-2">
                <?php 
